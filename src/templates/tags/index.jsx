...
const TagPage = ({ data, pageContext }) => {
  ...
  console.log(tag);
  let tagName = Config.tags[tag] ? Config.tags[tag].name : Utils.capitalize(tag);
  const tagPagePath = Config.pages.tag;

  const tagImageBox = data.allFile.edges.find((edge) => edge.node.name === tag);

  const tagImage = (tagImageBox) ?  tagImageBox.node.childImageSharp.fluid : '';
